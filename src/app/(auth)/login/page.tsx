      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-amber-500 rounded-2xl mb-4">
            <svg className="w-8 h-8 text-zinc-950" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M8 17h8M3 17l1.5-7h15L21 17M5 10V7a2 2 0 012-2h10a2 2 0 012 2v3" />
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-white">Transporte JR</h1>
          <p className="text-zinc-500 text-sm mt-1">Sistema de gestión operativa</p>
        </div>
