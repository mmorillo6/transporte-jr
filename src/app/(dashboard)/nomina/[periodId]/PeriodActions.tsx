...
export default function PeriodActions({ periodId, periodStatus, role, checklistData }: {
  ...
  async function handleDelete() {
    ...
    setDeleting(true)
    const res = await deletePeriodWithPassword(periodId, deletePassword)
    setDeleting(false)
    ...
    <>
      ...
      {showDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-zinc-900 border border-red-900/60 rounded-2xl w-full max-w-sm shadow-2xl">
